...
/**
 * Direct test of citation processing in the Pandoc microservice
 */
...
<body>
    ...
    <div class="content">
        <!-- Markdown content will be processed here -->
    </div>
...
async function testCitationProcessing() {
    try {
        console.log('Testing citation processing with Pandoc microservice...');
        ...
        const outputPath = path.join(__dirname, 'docker', 'citation-test.pdf');
